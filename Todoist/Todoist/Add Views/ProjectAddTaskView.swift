        ...
        VStack {
            ...
            HStack {
                ...
                Button () {
                    ...
                    if(date == nil) {
                        section.tasks.append(Task(name: vm.name, isCompleted: false, description: vm.description))
...
struct ProjectAddTaskView_Previews: PreviewProvider {
    static var previews: some View {
        ProjectAddTaskView(ts: TodoistService(), vm: ProjectAddTaskViewModel(), section: .constant(ProjectSection(name: "")), project: .constant(Project(name: "Project", sections: [])))
    }
}
